...
<body class="hold-transition sidebar-mini layout-fixed')}}">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{url('admin/shoes/showShoes')}}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Danh sách giày</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{url('admin/shoes/addShoes')}}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Thêm giày</p>
                  </a>
                </li>
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{url('admin/employees/showEmployees')}}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Danh sách nhân viên</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{url('admin/employees/addEmployee')}}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Thêm nhân viên</p>
                  </a>
                </li>
  ...
  <script src="{{asset('backend/dist/js/pages/dashboard.js')}}">
  </script>
  <script src="https://cdn.jsdelivr.net/npm/flatpickr"></script><script src="https://npmcdn.com/flatpickr/dist/l10n/vn.js"></script>
  <script>
    flatpickr ("#myID", {
      dateFormat: "d-m-Y",
      maxDate:"today",
